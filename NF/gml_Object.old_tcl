...
#
#   Copyright (c) 2001-2005 CLIPS-IMAG
#
...
#     WARNING! Icompatibility: the destructor is now called event if the call to the
#       constructor failed.
# 
...
#     Classes and objects can no be renamed with the "rename" tcl command.
# 
...
upvar #0 $className class
  ...
  if { [llength [info procs $className]] } {
    error "could not create class \"$className\": a procedure with that name already exists"
  }
