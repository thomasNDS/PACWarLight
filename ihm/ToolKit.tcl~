...
method ToolKit_P constructor {control can} {
	...
	pack [entry .f.f2.angle -width 15 -relief sunken -textvariable this(angleSelection)] -side top
	pack [label .f.f2.strvitesse -text "vitesse"] -side top
	pack [entry .f.f2.velocity -width 15 -relief sunken -textvariable this(velocitySelection)] -side top
...
method ToolKit_P setShipSelected {x y fire angle } {
	set  this(angleSelection) $angle
	set  this(velocitySelection) $fire
	puts $angle
}
